 ...
 *         </p>
 */
public class DataStaDatabaseBuilder {
	 ...
	 */
	public DataStaDatabaseBuilder(String dbName) {
		this.mDBName = dbName;
	}
	 ...
	 */
	public <T extends DataStaBaseModel> void addClass(Class<T> c) {
	...
	public <T extends DataStaBaseModel> String getSQLCreate(String table) throws DataStaDataAccessException {
		...
		if (null != c) {
			sb = new StringBuilder("CREATE TABLE IF NOT EXISTS ").append(table).append(" (_id integer primary key");
