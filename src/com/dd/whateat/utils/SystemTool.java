...
public final class SystemTool {
	...
	public static String getAppVersion(Context context) {
		...
		try {
			...
			DdLog.e(SystemTool.class.getName(), "the application not found");
		}
		return version;
	}
	...
	public static String getSign(Context context, String pkgName) {
		try {
			...
			DdLog.e(SystemTool.class.getName(), "the "
	...
	public static int gc(Context cxt) {
			...
			for (RunningAppProcessInfo process : processList) {
				...
				if (process.importance > RunningAppProcessInfo.IMPORTANCE_VISIBLE) {
					...
					for (String pkgName : pkgList) {
						DdLog.d(SystemTool.class.getName(), "======正在杀死包名：" + pkgName);
						try {
		...
		DdLog.d(SystemTool.class.getName(), "清理了" + (getDeviceUsableMemory(cxt) - i)
				+ "M内存");
		return count;
	}
}